function [alfa_c] = capacitor_c(temperatura_ambiente,capacitancia,tensao,tensao_nominal)
alfa_b = 0.00037;
temperatura = temperatura_ambiente;
pi_t = exp(-0.35/8.617e-5*(1/(temperatura+273)-1/298));
pi_c = capacitancia^0.09;
pi_v = (((tensao/tensao_nominal)/0.6)^3)+1;
